...
uint256 hashGenesisBlock("0xeee7f58d111ef0b25f7f6e8703d80ab6b51ca957170daea949e93e6467906889");
...
static const int64 nTargetTimespan = 1 * 24* 60 * 60; // Masscoin: 1 day
static const int64 nTargetSpacing = 1 * 15; // Masscoin: 15 sec
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xe0d8c255be8de843e56b2b31c65126e7732da28504046437077173b01b7cb222");  //testnet hash
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "made by blockchain developers @ auxesis group";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        if (fTestNet)
        {
            block.nTime    = 1518520229;    //testnet time
            block.nNonce   = 385619194;
        }
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc2, 0xba, 0xd3 }; // Masscoin: increase each by adding 2 to bitcoin's value.
